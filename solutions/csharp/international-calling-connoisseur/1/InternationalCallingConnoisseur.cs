public static class DialingCodes
{
    ...
    {
        Dictionary<int, string> dict = DialingCodes.GetEmptyDictionary();
    ...
    {
        return existingDictionary.TryGetValue(countryCode, out string? value) ? value : string.Empty;
    }
    ...
    public static string FindLongestCountryName(Dictionary<int, string> existingDictionary)
    {
        ...
        {
            if (longestCountry.Length < countryName.Length)
            {
